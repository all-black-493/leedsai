        ...
        <TriggerButton label='Add Trigger'>
            <div className="flex flex-col gap-y-2">
                    ...
                    <div
                        ...
                        className={cn(
                            ...
                            !types?.find((t) => t === trigger.type)
                                ? 'bg-background/80'
                                : 'bg-linear-to-br from-[#33cc8c] font-medium to-[#11724a]'
                        )}
                    >
                ...
                <Button
                    ...
                    className='bg-linear-to-br from-[#33cc8c] font-medium text-white to-[#0f593a]'
                >
